...
<div class="container-fluid row" style="margin-top: 70px;margin-bottom: 50px;">
    <h1>Отчет по сроку годности</h1>
    <div class="col">
        <div class="col"></div>
        <div class="col">


            <?= Html::beginForm(['reports/report_expiration_form', 'id' => 'otchet', 'name'=>'form1'], 'GET'); ?>
            ...
            <div class="form-group">
                ...
                <div style="display: flex;">
                    <?= Html::textInput('FIRST_DATE', null,['class' => 'form-control','style'=>'width:200px' ]); ?>
                    <?= Html::textInput('SECOND_DATE', null,['class' => 'form-control','style'=>'width:200px', 'autocomplete'=>'0']); ?>
